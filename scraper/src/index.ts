...
export { extractGrants, FULL_ARCHETYPE } from "./pipeline/extract-grants";
export { resolveArchetype, ARCHETYPES } from "./pipeline/archetypes";
export type { Archetype } from "./pipeline/types";
